 ...
 */
public class NajHodnotene extends Fragment {

    private List<CardPodnik> bar_list;
    ...
    public View onCreateView(LayoutInflater inflater,final ViewGroup container,
        ...
        podniky_view_list = view.findViewById(R.id.bar_list);

        firebaseAuth = FirebaseAuth.getInstance();

        podnikRecyclerAdapter = new PodnikRecyclerAdapter(bar_list);
                            ...
                            if (doc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                CardPodnik cardPodnik = doc.getDocument().toObject(CardPodnik.class).withId(cardPodnikId);
                                    ...
                                    if (isFirstPageFirstLoad) {
                                        ...
                                        bar_list.add(cardPodnik);

                                    } else {

                                        bar_list.add(0, cardPodnik);
