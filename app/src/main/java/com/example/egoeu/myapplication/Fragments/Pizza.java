...
public class Pizza extends Fragment {
    ...
    private List<CardPodnik> pizza_list;
    ...
    public View onCreateView(LayoutInflater inflater,final ViewGroup container,
        ...
        podniky_view_list = view.findViewById(R.id.pizza_list);

        firebaseAuth = FirebaseAuth.getInstance();

        podnikRecyclerAdapter = new PodnikRecyclerAdapter(pizza_list);
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                            ...
                            if (doc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if(cardPodnik.getTyp().contains("Pizzeria")){

                                    if (isFirstPageFirstLoad) {

                                        pizza_list.add(cardPodnik);

                                    } else {

                                        pizza_list.add(0, cardPodnik);
